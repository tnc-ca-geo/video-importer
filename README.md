...
1. [Camio Hooks Modules](https://github.com/CamioCam/examples/tree/master/batch_import). This module uses Camio to perform segmentation, analysis, and labeling.
